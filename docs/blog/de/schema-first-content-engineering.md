...
`learn-content-engine` · Schema aktuell v1.16 · framework-agnostisches TypeScript
...
- **Validierung.** Die neue Form braucht Regeln: Wohlgeformtheit im Schema, das `validate.ts` prüft, feldübergreifende Integrität in `rules.ts`.
