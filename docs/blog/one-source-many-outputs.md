...
> **Additive by policy.** The schema is versioned (currently 1.14) and only grows additively: new fields are optional, so a lesson written last year still validates today. You are never forced to migrate content just because the schema moved.
